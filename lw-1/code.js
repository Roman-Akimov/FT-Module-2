alert(
  "Вариант 2. Задание: Напишите исходный код программы, которая выводит в консоль все автоморфные числа на заданном пользователем отрезке [a, b]. Натуральное число называется автоморфным, если десятичная запись его квадрата оканчивается на десятичную запись этого числа."
);
